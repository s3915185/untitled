...
public class UserTransactionGlobalTool {
    ...
    @Tool(description = "Adds a new user transaction to the system. Accepts a InvestBalanceDTO object containing transaction details and returns the added transaction, including any auto-generated fields like the ID.")
    ...
    @Tool(description = "Adds multiple user transactions to the system. Accepts a list of InvestBalanceDTO objects and returns a list of the added transactions with auto-generated fields like IDs.")
    ...
    @Tool(description = "Fetches a single user transaction by its unique identifier. Returns the InvestBalanceDTO object with the details of the transaction, or null if the transaction is not found.")
    public UserTransactionDTO getOneTransactionById(Long id) {
        return userTransactionGlobalService.getOneTransactionById(id);
    }

    @Tool(description = "Fetches a list of user transactions based on a set of unique transaction IDs. Returns the corresponding list of InvestBalanceDTO objects.")
    ...
    @Tool(description = "Fetches a list of user transactions based on the userInfoId. Returns the corresponding list of InvestBalanceDTO objects.")
    ...
    @Tool(description = "Updates an existing user transaction. Accepts a modified InvestBalanceDTO object and returns the updated transaction with the changes applied.")
    ...
    @Tool(description = "Updates a list of user transactions. Accepts a list of modified InvestBalanceDTO objects and returns a list of updated transactions.")
